...
{
	public class SqlQueryBuilder<T1, T2, T3, T4, T5> : SqlQueryBuilderBase
	{
		public SqlQueryBuilder(SqlQueryBuilderBase sqlQueryBuilderBase) : base(sqlQueryBuilderBase)
		{
		}

		public SqlQueryBuilder<T1, T2, T3, T4, T5, TNew> LeftJoin<TNew>(Expression<Func<T1, T2, T3, T4, T5, TNew, string>> stringExpression, params object[] parameters)
		{
		...
		public SqlQueryBuilder<T1, T2, T3, T4, T5, TNew> InnerJoin<TNew>(Expression<Func<T1, T2, T3, T4, T5, TNew, string>> stringExpression, params object[] parameters)
		{
		...
		public SqlQueryBuilder<T1, T2, T3, T4, T5> Where(Expression<Func<T1, T2, T3, T4, T5, string>> stringExpression, params object[] parameters)
		{
			return Update(sqlBuilder => sqlBuilder.AddWhere(ParseStringFormatExpression(stringExpression.Body), parameters));
		}

		public SqlQueryBuilder<T1, T2, T3, T4, T5> ConditionalWhere(bool shouldFilter, Expression<Func<T1, T2, T3, T4, T5, string>> stringExpression, params Func<object>[] parametersFunc)
		{
		...
		public SqlQueryBuilder<T1, T2, T3, T4, T5> OrderBy(Expression<Func<T1, T2, T3, T4, T5, string>> stringExpression, OrderingDirection orderingDirection = OrderingDirection.Ascending)
		{
			return Update(sqlBuilder => sqlBuilder.AddOrderBy(ParseStringFormatExpression(stringExpression.Body), orderingDirection));
		}

		public SqlQueryBuilder<T1, T2, T3, T4, T5> Skip(uint rowCount)
		{
			return Update(sqlBuilder => sqlBuilder.AddSkip(rowCount));
		}

		public SqlQueryBuilder<T1, T2, T3, T4, T5> Take(uint rowCount)
		{
			return Update(sqlBuilder => sqlBuilder.AddTake(rowCount));
		}

		public SqlQueryBuilder<T1, T2, T3, T4, T5> Custom(Expression<Func<T1, T2, T3, T4, T5, string>> stringExpression, params object[] parameters)
		{
		...
		private SqlQueryBuilder<T1, T2, T3, T4, T5> Update(Action<SqlQueryBuilder<T1, T2, T3, T4, T5>> updateAction)
		{
			var clone = Clone();
			updateAction(clone);
		...
		/// <seealso cref="Update"/>
		private SqlQueryBuilder<T1, T2, T3, T4, T5, TNew> UpdateAndExpand<TNew>(Action<SqlQueryBuilder<T1, T2, T3, T4, T5>> updateAction)
		{
			var clone = Update(updateAction);

			return new SqlQueryBuilder<T1, T2, T3, T4, T5, TNew>(clone);
		}

		private SqlQueryBuilder<T1, T2, T3, T4, T5> Clone()
		{
			return new SqlQueryBuilder<T1, T2, T3, T4, T5>(this);
		}
	}
}
