...
{
	public class SqlQueryBuilder<T1, T2, T3, T4, T5, T6> : SqlQueryBuilderBase
	{
		public SqlQueryBuilder(SqlQueryBuilderBase sqlQueryBuilderBase) : base(sqlQueryBuilderBase)
		{
		}

		public SqlQueryBuilder<T1, T2, T3, T4, T5, T6, TNew> LeftJoin<TNew>(Expression<Func<T1, T2, T3, T4, T5, T6, TNew, string>> stringExpression, params object[] parameters)
		{
		...
		public SqlQueryBuilder<T1, T2, T3, T4, T5, T6, TNew> InnerJoin<TNew>(Expression<Func<T1, T2, T3, T4, T5, T6, TNew, string>> stringExpression, params object[] parameters)
		{
		...
		public SqlQueryBuilder<T1, T2, T3, T4, T5, T6> Where(Expression<Func<T1, T2, T3, T4, T5, T6, string>> stringExpression, params object[] parameters)
		{
			return Update(sqlBuilder => sqlBuilder.AddWhere(ParseStringFormatExpression(stringExpression.Body), parameters));
		}

		public SqlQueryBuilder<T1, T2, T3, T4, T5, T6> ConditionalWhere(bool shouldFilter, Expression<Func<T1, T2, T3, T4, T5, T6, string>> stringExpression, params Func<object>[] parametersFunc)
		{
		...
		public SqlQueryBuilder<T1, T2, T3, T4, T5, T6> Select(Expression<Func<T1, T2, T3, T4, T5, T6, string>> stringExpression)
		{
			return Update(sqlBuilder => sqlBuilder.AddSelect(ParseStringFormatExpression(stringExpression.Body)));
		}

		public SqlQueryBuilder<T1, T2, T3, T4, T5, T6> GroupBy(Expression<Func<T1, T2, T3, T4, T5, T6, string>> stringExpression)
		{
			return Update(sqlBuilder => sqlBuilder.AddGroupBy(ParseStringFormatExpression(stringExpression.Body)));
		}

		public SqlQueryBuilder<T1, T2, T3, T4, T5, T6> OrderBy(Expression<Func<T1, T2, T3, T4, T5, T6, string>> stringExpression, OrderingDirection orderingDirection = OrderingDirection.Ascending)
		{
			return Update(sqlBuilder => sqlBuilder.AddOrderBy(ParseStringFormatExpression(stringExpression.Body), orderingDirection));
		}

		public SqlQueryBuilder<T1, T2, T3, T4, T5, T6> Skip(uint rowCount)
		{
			return Update(sqlBuilder => sqlBuilder.AddSkip(rowCount));
		}

		public SqlQueryBuilder<T1, T2, T3, T4, T5, T6> Take(uint rowCount)
		{
			return Update(sqlBuilder => sqlBuilder.AddTake(rowCount));
		}

		public SqlQueryBuilder<T1, T2, T3, T4, T5, T6> Custom(Expression<Func<T1, T2, T3, T4, T5, T6, string>> stringExpression, params object[] parameters)
		{
		...
		private SqlQueryBuilder<T1, T2, T3, T4, T5, T6> Update(Action<SqlQueryBuilder<T1, T2, T3, T4, T5, T6>> updateAction)
		{
			var clone = Clone();
			updateAction(clone);
		...
		/// <seealso cref="Update"/>
		private SqlQueryBuilder<T1, T2, T3, T4, T5, T6, TNew> UpdateAndExpand<TNew>(Action<SqlQueryBuilder<T1, T2, T3, T4, T5, T6>> updateAction)
		{
			var clone = Update(updateAction);

			return new SqlQueryBuilder<T1, T2, T3, T4, T5, T6, TNew>(clone);
		}

		private SqlQueryBuilder<T1, T2, T3, T4, T5, T6> Clone()
		{
			return new SqlQueryBuilder<T1, T2, T3, T4, T5, T6>(this);
		}
	}
}
