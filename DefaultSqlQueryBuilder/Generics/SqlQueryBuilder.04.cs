...
namespace DefaultSqlQueryBuilder.Generics
{
	public class SqlQueryBuilder<T1, T2, T3, T4> : SqlQueryBuilderBase
	{
		...
		public SqlQueryBuilder<T1, T2, T3, T4> OrderBy(Expression<Func<T1, T2, T3, T4, string>> stringExpression, OrderingDirection orderingDirection = OrderingDirection.Ascending)
		{
