...
namespace DefaultSqlQueryBuilder.Generics
{
	public class SqlQueryBuilder<T1, T2, T3, T4> : SqlQueryBuilderBase
	{
		...
		public SqlQueryBuilder<T1, T2, T3, T4> Select(Expression<Func<T1, T2, T3, T4, string>> stringExpression, int? top = null)
		{
			return Update(sqlBuilder => sqlBuilder.AddSelect(ParseStringFormatExpression(stringExpression.Body), top));
		}

		public SqlQueryBuilder<T1, T2, T3, T4> SelectAll(int? top = null)
		{
