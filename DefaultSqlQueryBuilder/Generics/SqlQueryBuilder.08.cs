...
namespace DefaultSqlQueryBuilder.Generics
{
	public class SqlQueryBuilder<T1, T2, T3, T4, T5, T6, T7, T8> : SqlQueryBuilderBase
	{
		...
		public SqlQueryBuilder<T1, T2, T3, T4, T5, T6, T7, T8> Select(Expression<Func<T1, T2, T3, T4, T5, T6, T7, T8, string>> stringExpression, int? top = null)
		{
			return Update(sqlBuilder => sqlBuilder.AddSelect(ParseStringFormatExpression(stringExpression.Body), top));
		}

		public SqlQueryBuilder<T1, T2, T3, T4, T5, T6, T7, T8> SelectAll(int? top = null)
		{
		...
		public SqlQueryBuilder<T1, T2, T3, T4, T5, T6, T7, T8> OrderBy(Expression<Func<T1, T2, T3, T4, T5, T6, T7, T8, string>> stringExpression)
		{
